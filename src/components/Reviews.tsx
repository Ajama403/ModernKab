...
const Reviews = () => {
  const reviews = site.reviews.map((review, index) => {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-muted-foreground text-lg">
            Rated {site.ratingValue}⭐ by Ridgecrest homeowners ({site.reviewCount} reviews).
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 mb-12">
          ...
          <div className="flex items-center gap-3 bg-card p-4 rounded-xl shadow-card">
            <div className="w-12 h-12 bg-primary rounded flex items-center justify-center">
              <span className="text-white font-bold text-sm">Responsive scheduling</span>
            </div>
            <div>
