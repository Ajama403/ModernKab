import { Phone, Mail, MapPin, Facebook, Instagram, Youtube, Linkedin, BadgeCheck, Clock3, Globe, Building2 } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-primary-foreground/70 mb-6 leading-relaxed">
              {site.about.headline} Based in {site.baseCity}, serving {site.serviceArea} with dependable construction and repair work.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <Building2 className="w-5 h-5 text-secondary mt-1" />
                <span className="text-primary-foreground/70">{site.businessName}</span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href={site.mapsUrl} className="text-primary-foreground/70 hover:text-secondary transition-colors">
                  {site.fullAddress}
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Globe className="w-5 h-5 text-secondary mt-1" />
                <a href={site.websiteUrl} className="text-primary-foreground/70 hover:text-secondary transition-colors">
                  thefixrc.com
                </a>
              </li>
              <li className="flex items-start gap-3">
